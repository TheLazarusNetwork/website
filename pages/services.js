              ...
              <div className="w-full lg:w-6/12 px-4 ml-auto mr-auto text-center">
                <div className="pr-12">
                  <h1 className="text-white font-semibold text-4xl">
                    We diagnose your IT Security faults and weaknesses Before
                    Hackers Do
                  </h1>
                  <p className="mt-4 text-lg text-blueGray-200">
                    Hence we decided to work on a secure firewall which filters
                    the internet based on blacklisted Websites/IP/domains and
                    only allows the users to access safe websites. Our solutions
                    benefit enterprises, startups, smart homes and individuals
                    by giving them complete control over the internet - Its just
                    like setting up parental controls on any app but for the
                    entire network.
                  </p>
                </div>
              </div>
                ...
                <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-8 shadow-lg rounded-lg">
                  <div className="px-4 py-5 flex-auto">
                    ...
                    <h6 className="text-xl font-semibold">
                      Do you want to be sure your IT infrastructure is
                      completely secure?
                    </h6>
                    <p className="mt-2 text-blueGray-500">
                      Get detailed insight into the actual cybersecurity of your
                      IT infrastructure and essential apps with Lazarus’s
                      security testing as a service, along with a set of advice
                      on how to make them as hacker-proof as possible.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="lg:pt-12 pt-6 w-full md:w-4/12 px-4 text-center">
                <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-8 shadow-lg rounded-lg">
                  <div className="px-4 py-5 flex-auto">
                    ...
                    <h6 className="text-xl font-semibold">
                      Improve your information security by leveraging our
                      capabilities to:
                    </h6>
                    <p className="mt-2 text-blueGray-500">
                      Examine how well your cyber-environment is secured and
                      strong against APTs, ransomware, and other threats.
                    </p>
                    <p>
                      To avoid possible attacks, identify current weaknesses in
                      your network.
                    </p>
                    <p>
              ...
              <div className="lg:pt-12 pt-6 w-full md:w-4/12 px-4 text-center">
                <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-8 shadow-lg rounded-lg">
                  <div className="px-4 py-5 flex-auto">
                    ...
                    <p className="mt-2 text-blueGray-500">
                      Cybersecurity consultancy assists businesses in
                      proactively identifying security risks and holes in their
                      IT infrastructures. We will be providing full-service
                      information security consulting services to clients.
                    </p>
                    <p>
                      Dont jeopardize your security or productivity. Allow
                      access when it is required and deny it when it is not.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="flex flex-wrap items-center mt-32">
              <div className="w-full md:w-5/12 px-4 mr-auto ml-auto">
                ...
                <p className="text-lg font-light leading-relaxed mt-4 mb-4 text-blueGray-600">
                  Anonymous VPN uses WireGuard® P2P VPN Solution for bypassing
                  IP Fingerprinting to provide secure & private access to
                  geo-restricted content. Users get to choose the VPN Connection
                  from various countries and change IP addresses upon their
                  requirements. This means they get access to their favorite
                  content without sacrificing speed or bandwidth in case the
                  content provider detects a VPN and tries to block the access.
                  Our platform is capable of getting new anonymous VPN IP
                  addresses on the go just by a simple form filled by the user.
                </p>
              </div>
                ...
                <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 rounded-lg bg-blueGray-700">
                  <div className="card rounded-xl overflow-hidden transition-all duration-500 transform hover:-translate-y-6 hover:scale-105 shadow-xl hover:shadow-2xl cursor-pointer">
                    ...
                    <p className="px-4 text-center text-sm ">
                      Anonymous VPN uses P2P VPN Solution for bypassing IP
                      Fingerprinting. Get 100% anonymous internet browsing
                      around the world including restricted regions.
                      <br />
                      <br />
                      Lazarus VPN gives you encrypted internet surfing and
                      prevents hackers and malware from accessing your data
            ...
            <div className="items-center flex flex-wrap">
              <div className="w-full md:w-4/12 ml-auto mr-auto px-4">
                <div className="card rounded-xl overflow-hidden transition-all duration-500 transform hover:-translate-y-6 hover:scale-105 shadow-xl hover:shadow-2xl cursor-pointer">
                  ...
                  <p className="px-4 text-center text-sm ">
                    Lazarus VPN is an encrypted tunneling solution for end users
                    offering WireGuard® Tunneling, secured by Ed25519 Private
                    Key Encryption, Multi Region Network, Peer to Peer network
                    access along with network layer customizable firewall. Get
                    higher bandwidth and optimized performance for enterprise
                    software usages requiring good latency.
                    <br />
                    <br />
                    Lazarus Firewall is incorporated on the network layer (DNS
                    Layer) for detecting and eliminating cyber threats which try
                    to attack the application system.
                  </p>
                  <ul className="text-center py-4">
                    <li>
                      <p className="font-semibold hover:text-blue-800">
                        All the features of ANONYMOUS VPN
                      </p>
                    </li>
                    <li>
                      <p className="font-semibold hover:text-blue-800">
                        Dedicated Network - Secure Tunnel
                      </p>
                    </li>
                    <li>
                      <p className="font-semibold hover:text-blue-800">
                        Network Layer Customizable Firewall
                      </p>
                    </li>
                    <li>
                      <p className="font-semibold hover:text-blue-800">
                        Dedicated Bandwidth and Performance - Not Shared
                      </p>
                    </li>
                  </ul>
                  <div className="text-center bg-pink-600 ">
              ...
              <div className="w-full md:w-5/12 ml-auto mr-auto px-4">
                <div className="md:pr-12">
                  <h3 className="text-3xl font-semibold">
                    SOTREUS [DEDICATED NETWORK]
                  </h3>
                  <p className="mt-4 text-lg leading-relaxed text-blueGray-500">
                    This service offers a dedicated IP based virtual private
                    network to the users for connecting their enterprise or home
                    smart devices so that they can be accessed from anywhere. It
                    is focused on enterprise grade security level configurations
                    and comes integrated with a Firewall in the same region as
                    the VPN. All the configurations are logged and managed
                    through the organization owners and admins. It supports
                    higher bandwidth and optimized performance for enterprise
                    software usages requiring good latency.
                  </p>
