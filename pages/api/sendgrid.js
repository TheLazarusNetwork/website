...
async function sendEmail(req, res) {
  try {
    await sendgrid.send({
      to: "singhdevsi943@gmail.com", // Your email where you'll receive emails
      from: "singhdevsi943@gmail.com", // your website email address here
