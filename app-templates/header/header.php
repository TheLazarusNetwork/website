        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav mx-auto fill-flex justify-content-center">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#tunnel">Tunnel</a>
                    </li>
                    <li class="nav-item">
            ...
            <div class="row d-flex align-items-center">
                <div class="col-lg-6 offset-lg-0 col-md-10 offset-md-1 col-sm-10 offset-sm-1 text-center text-lg-left mb-5 mb-lg-0">
                    <div class="pr-0 pr-xl-5 pr-lg-0">
                        <h1 class="main-content__title mb-3 mb-lg-4 h2">Enterprise Cybersecurity</h1>
                        <p class="main-content__lead lead mb-4">Leveraging AI And Blockchain Technologies For Cyber Defense.</p>
                ...
                <div class="col-lg-6 text-center text-lg-right position-relative">
                    <img src="<?php echo get_template_directory_uri().'/app-resources/images/hero-illustration-2.png'; ?>"
                        alt="" class="main-content__img img-fluid">
                </div>
            </div>
        </div>
    </div>
