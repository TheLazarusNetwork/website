...
function load_scripts(){
  ...
  wp_enqueue_style('modal-video-style',$resource_dir.'/app-resources/css/modal-video.min.css',false,'1.0');
  ...
  wp_enqueue_script('modal-video',$resource_dir.'/app-resources/js/jquery-modal-video.min.js',array('jquery'),'1.0',true);
