...
<section id="pricing" class="pricing pricing-5 section section--padding section--gradient__5">
  <div class="container">
      <div class="row">
          <div class="preamble col-lg-8 offset-lg-2 section--gradient__7">
              <h3 class="title text-white my-3">Personal Security Plans</h3>
              <p class="lead text-dark">Demonstrating core competencies to in turn innovate. Create stakeholder engagement so that we gain traction.</p>
          </div>
      </div>
      <div class="row">
          <div class="col-lg-4">
