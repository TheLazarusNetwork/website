...
import net from '../../../assets/images/m.jpg'
            ...
            <Row className="">
              <Col md="6" className="align-self-center md:pl-28 md:pt-0">
                <h1 className="title" style={{ color: "black" }}>
                  Enterprise Grade Cybersecurity Solutions for Individuals and
                  Businesses
                </h1>
                <h6 className="subtitle op-8" style={{ color: "black" }}>
                  Leveraging AI And Blockchain Technologies For Cyber Defense to
                  protect you from online Viruses while you Work From Home.
                </h6>
                {/* <h6 className="subtitle op-8" style={{color: 'black'}}>
              </h6> */}
